# agentic-config Installation Guide

Complete guide to installing agentic-config components using the automated installer script.
...
bash <(curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh)

# Quick install with profile
bash <(curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh) developer
```
...
bash <(curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh) essential

# Developer - Code-focused development tools
bash <(curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh) developer

# Business - Content and business-focused tools
bash <(curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh) business

# Full - Everything except system-builder
bash <(curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh) full

# Advanced - Complete system with all components
bash <(curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh) advanced
```
...
- **Documentation:** [GitHub Repository](https://github.com/fcimeson/agentic-config)
- **Report issues:** [GitHub Issues](https://github.com/fcimeson/agentic-config/issues)

---

## Summary

The agentic-config installer provides:
...
Choose the installation method that fits your needs and get started with agentic-config!
