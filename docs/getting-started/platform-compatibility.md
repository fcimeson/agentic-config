...
The agentic-config installer is designed to work across multiple platforms and bash versions.
...
curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh | bash -s core
```
...
curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/scripts/tests/test-compatibility.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/fcimeson/agentic-config/main/install.sh > install.sh
