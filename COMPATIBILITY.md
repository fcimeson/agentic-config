...
This is a fork of https://github.com/darrenhinde/OpenAgents.
If you hit an issue that reproduces upstream, consider checking whether it's already addressed there.
```
...
3. Report issues: [GitHub Issues](https://github.com/fcimeson/agentic-config/issues)
